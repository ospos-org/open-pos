...
export default function CashSelect({ totalCost, changeCallback }: { totalCost: number, changeCallback: Function }) {
    ...
    return (
        <div className="flex flex-col gap-12 items-center justify-center flex-1">
            <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-white text-4xl font-bold">${totalCost?.toFixed(2)}</p>
            </div>
            ...
            <div className="flex flex-col gap-2 items-center">
                ...
                <p className="text-white text-4xl font-bold">${Math.abs(totalCost - selectedValue)?.toFixed(2)}</p>
            </div>
        </div>
    )
}