...
function OTooltip({ children, name, side = "right" }: { children: React.ReactElement, name: string, side?: Side }) {
    return (
        <Tooltip.Provider delayDuration={100}>
            <Tooltip.Root>
                ...
                <Tooltip.Portal>
                    <Tooltip.Content className="TooltipContent" sideOffset={25} side={side}>
