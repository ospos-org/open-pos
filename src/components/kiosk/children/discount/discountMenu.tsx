...
const DiscountMenu: FC<{ callback: Function, multiple: boolean }> = ({ callback, multiple }) => {
    ...
    const discountedPrice = useMemo(() =>
            applyDiscount(retailPrice, `${discount?.type == "absolute" ? "a" : "p"}|${discount?.value}`),
    ...
    return (
        <>
            <div className="flex flex-col h-full gap-12 justify-center">
                <div className="self-center flex flex-col items-center justify-center">
                    ...
                    <div className="flex flex-row items-center text-white">
                        ...
                        <input
                            ...
                            defaultValue={(discount.value !== 0) ? (discount.value).toFixed(2) : ""}
                ...
                <div className="flex flex-row items-center gap-4 self-center">
                    ...
                    >
                        <Image
                            ...
                            style={{
                                filter: discount.type == "absolute" ? WHITE_FILTER : GRAY_FILTER
                            }}
                        />
                    ...
                    >
                        <Image
                            ...
                            className="text-white"
                            style={{
                                filter: discount.type == "percentage" ? WHITE_FILTER : GRAY_FILTER
                            }}
                        />
                ...
                <div className="self-center flex-col items-center justify-center">
                    <div className="flex flex-row items-center gap-4">
                        ...
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <p className={`${(discountedPrice ) < 0 ? "text-red-400" : "text-white"} font-bold`}>
                        ...
                        <div>
                            ...
                            <p className={`${(discountedPrice ) < 0 ? "text-red-400" : "text-white"}`}>
                ...
                <div
                    onClick={() => setDiscount({ ...discount, exclusive: !discount.exclusive })}
                ...
                >
...

                    {
                        !discount.exclusive ?
                        <Image
                            src="/icons/square.svg" alt="selected"
                            width={20} height={20}
                            style={{ filter: GRAY_FILTER }} />
                        :
                        <Image
                            src="/icons/check-square.svg" alt="selected"
                            width={20} height={20}
                            style={{ filter: GRAY_FILTER }} />
                    }
                </div>
            ...
            <div className="flex flex-row items-center gap-4">
                ...
                <div
                    ...
                    className={`
                        ${multiple ? "bg-blue-700 cursor-pointer" : "bg-blue-700 bg-opacity-10 opacity-20"} 
