    ...
    return (
        <div className="flex flex-row items-start gap-4 px-2 py-4">
            ...
            <div className="text-white">
                <p className="font-semibold">{customerOrStore?.contact.address.street}</p>
                <p>{customerOrStore?.contact.address.street2}</p>
                <p className="text-gray-400">{customerOrStore?.contact.address.city} {customerOrStore?.contact.address.po_code}</p>
                <p className="text-gray-400">{customerOrStore?.contact.address.country}</p>
            </div>
        </div>
    )
}