...
export function DispatchShippingRate({
	generatedOrder,
}: DispatchShippingRateProps) {
	...
	const shipmentClasses = useMemo(
		() =>
			"text-white flex flex-row items-center justify-between bg-gray-800 px-4 py-2 rounded-sm cursor-pointer",
		[],
	);
