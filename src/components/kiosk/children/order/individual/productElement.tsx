        ...
        <div className="text-white">
            <div className="flex flex-row items-center gap-4">
                <div className="flex flex-col md:flex-row items-center md:gap-4 gap-2">
                    <ProductImage currentOrder={currentOrder} product={product} quantityHere={quantityHere} />
                    <ProductQuantity currentOrder={currentOrder} product={product} totalStock={totalStock} />
                </div>
