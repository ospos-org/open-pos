...
export default function TransactionMultipleItem() {
	...
	const [selectorOpen, setSelectorOpen] = useAtom(
		transactionMenuSelectorOpenAtom,
	);
	...
	return (
		<div className="relative inline-block w-fit float-right flex-grow flex-shrink-0">
			<p className="text-gray-400 text-sm">
				Transaction contains multiple orders
			</p>
			...
			>
				<p className="font-semibold">
					{activeTransaction?.order_type.toUpperCase()} -{" "}
					{activeTransaction?.origin.store_code}
				</p>

				<Image
					src={
						selectorOpen ? "/icons/chevron-up.svg" : "/icons/chevron-down.svg"
					}
					style={{
						filter:
