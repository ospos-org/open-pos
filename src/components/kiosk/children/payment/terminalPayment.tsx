...
import {generateIntentAtom, paymentIntentsAtom, probingPricePayableAtom} from "@atoms/payment"
...
export function TerminalPayment() {
    ...
    const processPayment = useCallback(() => {
        ...
        const quantityPaid = payment_intents.reduce(function (prev, curr) {
        ...
        if(quantityPaid < (kioskState.order_total ?? 0) && kioskState.transaction_type != "Quote") {
    ...
    }, [computeTransaction, kioskState, generateIntent, setKioskPanel, setProbingPrice])
