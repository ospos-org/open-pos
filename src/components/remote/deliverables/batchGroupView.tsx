		...
		<div className="flex flex-col gap-2 py-4">
			{deliverables.length <= 0 ? (
				...
				<div
					...
					style={{ gridTemplateColumns: "125px 150px 100px 100px" }}
				>
					<div
						className="hidden sm:grid items-center justify-center text-left"
						style={{
							gridTemplateColumns: `1fr 140px ${
								(windowSize?.width ?? 0) > 640 ? "100px" : ""
							}`,
						}}
					>
					...
					{productCategories.map((b) => {
						return (
							<div
								key={`PRODUCT CATEGORIES: ${b.name}-${b.items.length}`}
